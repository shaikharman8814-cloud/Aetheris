const identityResponse =
    "Aetheris, built by SnyderAI, an AI technology company focused on building intelligent systems and research tools.";
...
/* ---------------- INSTANT RESPONSES ---------------- */
export const instantResponses: Record<string, string | (() => string)> = {
